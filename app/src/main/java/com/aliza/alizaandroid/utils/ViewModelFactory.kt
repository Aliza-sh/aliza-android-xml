...
import com.aliza.alizaandroid.ui.addOrUpdateStudent.AddOrUpdateStudentViewModel
...
class AddOrUpdateStudentViewModelFactory(private val mainRepository: MainRepository) :ViewModelProvider.Factory {

    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return AddOrUpdateStudentViewModel(mainRepository) as T
    }
